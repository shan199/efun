...
class MysqlPdoDriver implements DbInterface
{
    ...
    public function select($table, array $condition = [], $field = '*', $group = '', $order = NULL, $limit = NULL)
    {
        ...
        return $this->query("SELECT {$field} FROM {$table} {$condition['_where']} {$group} {$order} {$limit}", $condition['_bindParams']);
    }
