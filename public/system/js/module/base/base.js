...
(function ($, owner) {
    owner.bind = function ($el, config) {
        Do('dialog', function () {
            ...
            var $table = $($el).find('[data-table]'),
                $del = $table.find('[data-del]'),
                $refuse = $table.find('[data-refuse]') ,
                $agree =$table.find('[data-agree]') ;
            //更改状态
